...
export default function ChatInterface() {
  ...
  return (
    <div className="flex h-full relative overflow-hidden">
      ...
      {/* Sidebar */}
      <div
        className={`absolute left-0 top-0 h-full w-72 bg-gray-900 border-r border-gray-800 z-20 flex flex-col transition-transform duration-200 ${
      ...
      >
        ...
        <div className="px-3 py-2 flex-shrink-0">
          <button
            ...
            className="w-full text-sm text-left px-3 py-2 rounded-lg bg-orange-500/10 hover:bg-orange-500/20 text-orange-400 border border-orange-500/30 transition-colors"
          >
            + New chat
          </button>
        </div>
